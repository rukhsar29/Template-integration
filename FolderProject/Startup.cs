...
using Book.Entities;
using Book.Entities.Implementations;
...
namespace FolderProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<traffictraineesContext>(options => options.UseSqlServer("Server=n6.iworklab.com;Database=traffic-trainees;User ID=traffic-trainees;Password=TR32D9aWJRUS20#;"));
